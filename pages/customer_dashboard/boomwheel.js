...
//       if (response?.data) {
//         if (
//           response?.data?.payload.spin_cycle_counter + 1 ===
//           response?.data?.payload.spin_cycle_settings[0].ticket_cycle + 1
//         ) {
...
//         } else if (
//           response?.data?.payload.spin_cycle_counter + 1 ===
//           response?.data?.payload.spin_cycle_settings[1].ticket_cycle + 1
//         ) {
//           setisSettingMatched(true);
...
//     <Wrapper>
//       <Head>
//         <title>NairaBoom Customer BoomWheel</title>
...
//         {/* <Box bg={'red'} w={{ base: "50%", md: "40%" }} display={iisOpen ? 'block': "none"} maxW={"95%"}>
...
//         }}
//       >
//               {/* <div style={{position: "absolute", top:10 , width: width * 0.25, height: height}}>
//         <Confetti
//           width={500}
//           height={600}
//           confettiSource={{ w: width * 0.75, h: width * 0.75, x: 0 }}
//         />
//         </div> */}
//         <ModalOverlay />
//         <ModalContent
